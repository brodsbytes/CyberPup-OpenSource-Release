...
const Check1_5_1_SharingAwarenessScreen = ({ navigation, route }) => {
  ...
  const celebrateCompletion = () => {
    Alert.alert(
      '🎉 Sharing Awareness Complete!',
      'You\'ve developed smart sharing habits to protect your privacy. You can now share safely without putting yourself at risk!',
      [
        {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Check 1.5.1</Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalMessage}>
              You're developing smart sharing habits to protect your privacy. Don't let oversharing put you at risk!
            </Text>
      ...
      {isCompleted && (
        <View style={styles.completionCard}>
          <View style={styles.completionContent}>
            ...
            <Text style={styles.completionTitle}>Sharing Awareness Mastered!</Text>
